 ...
 * [Charset][java.nio.charset.Charset] and one implementation,
 ...
 * the problems with [ String.getBytes][java.lang.String.getBytes], which encodes unknown characters as ASCII
...
interface ZipEncoding {
     ...
     */
    fun canEncode(name: String): Boolean
